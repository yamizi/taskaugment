"""
From https://github.com/imrahulr/adversarial_robustness_pytorch/blob/main/gowal21uncovering
"""
...
def cutmix(images, labels, alpha=1.0, beta=1.0):
    """
...
def _compose_two_images(images, image_permutation, bbox):
    ...
    def _single_compose_two_images(image1, image2):
        ...
        mask = torch.Tensor(mask).to(image1.device)
