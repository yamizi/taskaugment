"""
Adapted from https://gist.github.com/etienne87/b79c6b4aa0ceb2cff554c32a7079fa5a
"""
...
if __name__ == '__main__':
    ...
    fig = pylab.imshow(im, cmap=pylab.gray())
    pylab.show()

    astronaut = np.moveaxis(im, -1, 0)[None, ...]
    ...
    hog = HOGLayerMoreComplicated(mean_in=False)
    if cuda:
        hog = hog.cuda()
