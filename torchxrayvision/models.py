...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16), num_init_features=64, bn_size=4,
                 ...
                 apply_sigmoid=False, tasks=None):
        ...
        if tasks==["rotation"]:
            num_classes = num_classes[1]["nb_rotations"]
        elif tasks==["jigsaw"]:
            num_classes = num_classes[1]["permutations_jigsaw"]
        else:
            num_classes = num_classes[0] if isinstance(num_classes,list) else num_classes
