...
def parse_args():
    ...
    parser.add_argument('--comet',          action='store_false')
    parser.add_argument('--class_to_train', type=str, default="Es")
    parser.add_argument('--class_to_test',  type=str, default="E")
