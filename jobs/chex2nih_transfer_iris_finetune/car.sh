...
#SBATCH -J "CHEX2NIH_FINE_R50_multitask_CAR"
#SBATCH -N 1
...
do
echo $MODEL
CUDA_VISIBLE_DEVICES=0 python  "experiments/task_augment/transfer.py" -name transfer_finetune_roc --dataset $DATASET --weights_file "best/${MODELSOURCE}_src-${MODEL}.pt" --batch_size 256 --labelfilter $MODEL --dataset_dir "/mnt/lscratch/users/sghamizi/datasets/datasets" --output_dir "/mnt/irisgpfs/projects/multi_task_chest_xray/$MODELDATASET"
count++
done