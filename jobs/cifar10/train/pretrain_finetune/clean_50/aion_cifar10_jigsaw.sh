...
WEIGHTS="/mnt/lscratch/users/sghamizi/models/baseline_pretrain/aux_cifar10/best/resnet50/class_object#multilabel_jigsaw-1.0-4_optim-sgd.pt"
DATASUBSET=0.5
