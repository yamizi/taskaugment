...
#SBATCH -J "C10_R50_Pre_adv_rotation"
#SBATCH -N 1
...
WEIGHTS="/mnt/lscratch/users/sghamizi/models/baseline_pretrain/aux_cifar10/best/resnet50/class_object#multilabel_rot-1.0-4_optim-sgd.pt"
DATASUBSET=0.1
