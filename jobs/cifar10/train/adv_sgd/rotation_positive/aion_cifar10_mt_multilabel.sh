...
CUDA_VISIBLE_DEVICES=0 python experiments/train_baseline.py --labelfilter "class_object#multilabel" --num_epochs 400 --lr 0.1 --optimizer "sgd" --steps 10 --attack_target "multilabel"  -name train-baseline-weight --dataset aux_cifar10_train --loss_rot 1 --batch_size 384 --nb_secondary_labels 4 --model multi_task_resnet50 --dataset_dir  /mnt/lscratch/users/sghamizi/datasets/datasets --output_dir  /mnt/lscratch/users/sghamizi/models/baseline_weight --weight_strategy ${1:-mgda} --force_cosine ${2:-0}