...
#SBATCH -J "CIFAR10_R50_perfGowal"
#SBATCH -N 1
...
EVALATK=${2:-PGD}
TRAINATK=${3:-MADRY}
NAME="aaai_resubmission_gowal"
OUTPUTDIR="/mnt/lscratch/users/yletraon/models/baseline_${WEIGHT}/gowal/$DATASET"
BATCHSIZE=384
SEED=10
WEIGHTS="/mnt/lscratch/users/yletraon/models/baseline_madry/aux_cifar10_train-multi_task_resnet50-train-gowal-madry-mgda-class_object#multilabel_augment-gowal_adv-multilabel_optim-sgd_subset-0.1_cosine-0_w-mgda_a-MADRY-best.pt"
