...
MODEL="resnet50"
NAME="adv_baseline_fast"
OUTPUTDIR="/mnt/lscratch/users/sghamizi/models/baseline_f/$DATASET"
DATASETDIR="/mnt/lscratch/users/sghamizi/datasets/datasets"
WEIGHT=${1:-ew}
EVALATK=${2:-PGD}
TRAINATK=${3:-MADRY}
SUFFIX="_adv-multilabel_optim-sgd_cosine-0_w-${WEIGHT}_a-FAST"
PREFIX="fast-"
