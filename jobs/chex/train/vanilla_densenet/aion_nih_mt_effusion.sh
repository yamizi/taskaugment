...
CUDA_VISIBLE_DEVICES=0 python experiments/train_xrayvision.py --batch_size 32 --labelfilter "Effusion"  -name train-xray-densenet --dataset chex --model multi_task_densenet --dataset_dir  /mnt/lscratch/users/sghamizi/datasets/datasets --output_dir  /mnt/lscratch/users/sghamizi/models/xray
