...
CUDA_VISIBLE_DEVICES=0 python experiments/train_xrayvision.py --batch_size 32 --labelfilter "Pneumothorax"  --lr  0.001 -name train-xray-densenet --dataset chex --model multi_task_densenet --dataset_dir  $DATASETDIR --output_dir  $OUTPUTDIR
