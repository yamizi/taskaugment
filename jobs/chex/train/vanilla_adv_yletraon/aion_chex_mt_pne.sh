...
CUDA_VISIBLE_DEVICES=0 python experiments/yamizi/sota_advfinetune.py --lr 0.1 --max_eps 4 --step_eps 1 --optimizer "sgd" --steps 10 --num_epochs 50  -name "adv_finetune" --batch_size 180 --img_size 256 --main_metric "auc" --attack_target "Pneumonia" --labelfilter "Atelectasis-Edema-Effusion-Cardiomegaly-Consolidation-Pneumothorax-Pneumonia"  -name train-xray-resnet50 --dataset chex --dataset_dir  $DATASETDIR --output_dir  $OUTPUTDIR