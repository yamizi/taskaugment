...
CUDA_VISIBLE_DEVICES=0 python experiments/train_xrayvision.py --batch_size 64 --labelfilter "Atelectasis-Pneumothorax"  -name train-xray-resnet34 --dataset chex --model multi_task_resnet34 --dataset_dir  $DATASETDIR --output_dir  $OUTPUTDIR