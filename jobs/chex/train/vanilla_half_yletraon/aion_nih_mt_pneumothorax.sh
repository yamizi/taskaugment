...
#SBATCH -J "CHEX_Resnet50_h_multitask_Pneumothorax"
#SBATCH -N 1
...
CUDA_VISIBLE_DEVICES=0 python experiments/train_xrayvision.py --batch_size 64 --data_subset 0.5 --labelfilter "Pneumothorax"  -name train-xray-resnet50 --dataset chex --model multi_task_resnet50 --dataset_dir  $DATASETDIR --output_dir  $OUTPUTDIR
