...
WEIGHTS="/mnt/lscratch/users/sghamizi/models/c100/baseline_pretrain/aux_cifar10/best/resnet50/class_object#multilabel_rot-1.0-4_optim-sgd.pt"
DATASUBSET=0.1
...
CUDA_VISIBLE_DEVICES=0 python experiments/train_baseline.py --labelfilter "class_object#multilabel"  -name train-baseline-weight-finetune  --attack_target "multilabel" --data_subset $DATASUBSET --weights_file $WEIGHTS --optimizer "sgd"  --lr 0.5  --dataset aux_cifar100_train --loss_rot 1 --batch_size 512 --nb_secondary_labels 4 --model multi_task_resnet50 --dataset_dir  $DATASETDIR --output_dir  $OUTPUTDIR  --num_epochs 200 --seed 20